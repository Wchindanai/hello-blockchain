...
const Section2 = () => {
    const text = "การทำงานของ Blockchain นั้น เป็นรูปแบบการเก็บข้อมูลรูปแบบหนึ่ง คล้ายๆกับระบบฐานข้อมูล" +
        "โดยจะเก็บข้อมูลนั้นลงเป็นบล็อคๆต่อกันเรื่อยๆ โดยแต่ละบล็อคนั้นจะอ้างอิงบล็อคก่อนหน้า" +
        "โดยข้อมูลจะสามารถแชร์ไปยังทุกๆ คนได้ " +
        "โดยที่ในข้อมูลนั้นระบุว่าใครที่เป็นเจ้าของและมีสิทธิในข้อมูลนั้นจริงๆ " +
        "เมื่อบล็อกของข้อมูลได้ถูกบันทึกไว้ใน Blockchain แล้ว มันเป็นเรื่องที่ยากมากๆ ที่ข้อมูลใน Blockchain จะถูกเปลี่ยนแปลง เนื่องจาก" +
        "ข้อมูลพวกนั้นถูกเข้ารหัสไว้หมดแล้ว " +
        "เวลาที่มีใครต้องการจะเพิ่มข้อมูล ทุกๆ คนในเครือข่ายซึ่งล้วนแต่มีสำเนาของ Blockchain และสามารถรัน Algorithm " +
